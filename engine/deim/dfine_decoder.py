...
class MSDeformableAttention(nn.Module):
    def __init__(
        ...
        self.sampling_offsets = nn.Linear(embed_dim, self.total_points * 2) #*2 cause 2D offset
    ...
    def forward(self,
                ...
                value: torch.Tensor, # all feature maps from encoder
...
class DFINETransformer(nn.Module):
    ...
    def _get_decoder_input(self,
        ...
        if denoising_bbox_unact is not None: #T
